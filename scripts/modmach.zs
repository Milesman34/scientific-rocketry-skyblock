...
mods.extendedcrafting.TableCrafting.addShaped(0, <modularmachinery:itemblueprint>.withTag({ dynamicmachine: "modularmachinery:cosmic_forge" }), [
	...
	[<environmentaltech:structure_frame_6>, <enderio:item_endergy_conduit:11>, <modularmachinery:blockcasing:5>, <extracells:storage.component:10>, <extendedcrafting:material:40>, <extracells:storage.component:10>, <modularmachinery:blockcasing:5>, <enderio:item_endergy_conduit:11>, <environmentaltech:structure_frame_6>], 
	[<environmentaltech:structure_frame_6>, <ore:crystalAdamantium>, <extracells:storage.component:3>, <ore:blockMithril>, <extendedcrafting:material:13>, <ore:blockMithril>, <extracells:storage.component:3>, <ore:crystalAdamantium>, <environmentaltech:structure_frame_6>], 
